...
require (
	github.com/armosec/armoapi-go v0.0.456-0.20241008053126-d28b5510d01f
	github.com/armosec/armosec-infra v0.0.74-0.20241008053845-07b8f9d97a97
...
require (
	...
	github.com/kubescape/k8s-interface v0.0.163 // indirect
